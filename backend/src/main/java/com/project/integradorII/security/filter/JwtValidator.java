...
public class JwtValidator extends OncePerRequestFilter {
    ...
    //Este metodo se va ejecutar por cada peticion que se haga al servidor
    @Override
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if(token != null){
            ...
            DecodedJWT decodedJWT = jwtUltils.validateToken(token);

            String username  = jwtUltils.extractUsername(decodedJWT);
            String stringAuthorities = jwtUltils.getSpecificClaim(decodedJWT, "authorities").asString();
